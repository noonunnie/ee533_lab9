...
//  /   /         Filename : ALU1Bit.vf
// /___/   /\     Timestamp : 03/23/2026 19:41:37
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w Z:/shared/SharedProjects/ee533_lab9/ALU1Bit.sch ALU1Bit.vf
//Design Name: ALU1Bit
//Device: virtex2p
//Purpose:
...
module ALU1Bit(a, 
   ...
   XOR2 XLXI_9 (.I0(b), 
                .I1(XLXN_93), 
                .O(XLXN_15));
   M2_1_MXILINX_ALU1Bit XLXI_15 (.D0(AddSub_Carry), 
                                 .D1(a), 
                                 .S0(XLXN_49), 
                                 .O(cout));
   ...
   AND2 XLXI_40 (.I0(op[1]), 
                 .I1(op[0]), 
                 .O(XLXN_84));
   AND2B1 XLXI_51 (.I0(XNOR_Res), 
                   .I1(Ep), 
                   .O(En));
   OR2 XLXI_52 (.I0(XLXN_143), 
                .I1(XLXN_142), 
                .O(Gn));
   AND2B1 XLXI_53 (.I0(XNOR_Res), 
                   .I1(Gp), 
                   .O(XLXN_143));
   AND3B1 XLXI_55 (.I0(b), 
                   .I1(a), 
