...
//  /   /         Filename : IFIDReg.vf
// /___/   /\     Timestamp : 03/23/2026 19:41:51
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w Z:/shared/SharedProjects/ee533_lab9/IFIDReg.sch IFIDReg.vf
//Design Name: IFIDReg
//Device: virtex2p
//Purpose:
...
module FD16CE_MXILINX_IFIDReg(C, 
                              CE, 
                              CLR, 
                              D, 
                              Q);
...
module IFIDReg(clk, 
   ...
   FD16CE_MXILINX_IFIDReg XLXI_1 (.C(clk), 
                                  .CE(XLXN_2), 
                                  .CLR(XLXN_4), 
                                  .D(Inst[15:0]), 
                                  .Q(InstOut[15:0]));
   ...
   GND XLXI_2 (.G(XLXN_4));
   VCC XLXI_3 (.P(XLXN_2));
   FD16CE_MXILINX_IFIDReg XLXI_4 (.C(clk), 
                                  .CE(XLXN_8), 
                                  .CLR(XLXN_7), 
                                  .D(Inst[31:16]), 
                                  .Q(InstOut[31:16]));
